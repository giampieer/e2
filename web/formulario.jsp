...
<html lang="en">
    <head>
        ...
        <script src='https://www.google.com/recaptcha/api.js'></script>
         <script src='assets/js/ajax2424.js'></script>
    </head>
            ...
            <div class="container-login100">
                <div class="wrap-login100">
                    <form class="login100-form validate-form" name="form">
                        ...
                        <select name="tickets" class="form-control" data-validate="Ingrese Cantidad de Tickets" id="posicion1" onchange="refresh();">
                            <option value="0" selected>--------Cantidad de Entradas--------</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                        </select><br>
                        <select name="bank" class="form-control" data-validate="Ingrese Banco" id="bank" onchange="refresh();">
                        ...
                        <div class="container-login100-form-btn">
                            <button class="login100-form-btn" onclick="EventAlert('<%=request.getContextPath()%>')">
                                Aceptar
                            </button>
                        </div>
                    </form>
